...
<title>CARA ORDER HEBATKAN STORE</title>
...
<br /></td>
    ...
    <th width="400" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="Area_Produk">
      <tr>
        <th align="left" valign="top" class="Teks_Produk" scope="col">HOW TO ORDER</th>
      </tr>
      <tr>
        <th align="left" valign="top" class="Teks_Produk" scope="col"><hr /></th>
      </tr>
      <tr>
        <td align="left" valign="top"><p class="Teks_Informasi">Bacalah langkah-langkah dibawah ini untuk membeli barang di HEBATKAN STORE</p>
          <p class="Teks_Informasi">Anda harus login terlebih dahulu, Tidak punya akun? Anda bisa daftar akun dengan meng-klik sign up pada halaman utama dibawah button Log in.</p>
          ...
          <p class="Teks_Informasi">HEBATKAN STORE</p>
    ...
    <td width="200" align="left" valign="top" bgcolor="#E8EED7"><div class="Area_Menu_Kanan">
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" valign="top" class="Teks_Informasi" scope="col">CS Online : 0858 8066 5530<br />
